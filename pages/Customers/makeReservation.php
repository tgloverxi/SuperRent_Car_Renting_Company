...
<div class="right-container">
    ...
    <form action="makeReservation.php" method="POST">
        <fieldset class="box">
            ...
            <input type="submit" name="submit_reservation" value = "Make Reservation" style="horiz-align: left">
        </fieldset>
    </form>
...
function insertReserveRequest() {
    ...
    $result = executePlainSQL("SELECT vtName, city, location FROM vehicles WHERE vlicense = '$vId'");
    ...
    executePlainSQL("UPDATE vehicles SET status = 'reserved' WHERE vlicense = '$vId'");
    echo "<center><br> Reservation completed! <br></center>";
    //echo "<center><h4>Reservation Receipt</h4></center>";
    echo "<center><table></center>";
    echo "<tr><th><h2>" .'Reservation'. "<h2></th><th><h2>" . "Receipt" . "<h2></th></tr>";
        ...
        echo "<tr><td>" .'Location'. "</td><td>" . $row[2] . "</td></tr>";
